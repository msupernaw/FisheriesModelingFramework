 ...
 *<br>Student t         pt	 qt	  dt	   rt           StudentTDistribution
...
namespace atl {
     ...
     *  T Probability(const T &x) const<br>
     *  T Cumulative(const T &x) const<br>
     *  T Inverse(const T &probability) const<br>
     *  T Random() const<br><br>
     * 
     * @param x
     * @return 
     */
    ...
    public:
         ...
         */
        virtual T Probability(const T &x) const = 0;
         ...
         */
        virtual T Cumulative(const T &x) const = 0;
         ...
         */
        virtual T Inverse(const T &probability) const = 0;
    ...
    const T dnorm(const T &x, const T &mean, const T &sd) {
        return (T(1.0) / (std::sqrt(T(2.0) * sd * T(M_PI))))*
    ...
    const T rnorm(const T &mean, const T &standard_deviation) {
        ...
        T ret = qnorm<double> (x, mean, standard_deviation);
        return ret;
    }
    ...
    public:
        ...
        NormalDistribution(T mean = T(0), T standard_deviation = T(1)) :
        mean(mean),
         ...
         * @return the value X for which P(x<X).
         */
        T Inverse(const T &probability) const {
     ...
     */
    template<class T>
    T dbeta(const T &x, const T &a, const T &b) {
        if (x <= T(0.0) || x >= T(1.0)) {
            return 0.0;
        } else {
     ...
     */
    template<class T>
    T pbeta(const T &x, const T &a, const T &b) {
        if (x <= T(0)) {
     ...
     */
    template<class T>
    T qbeta(const T &probability, const T &a, const T &b) {
        T result = T(0);
        T guess = T(0.1);
        T high = T(100);
        T low = T(-100);
     ...
     */
    template<class T>
    T rbeta(const T &a, const T &b) {
        double x = ((double) rand() / (double) RAND_MAX);
        T ret = qbeta<double> (x, a, b);
        return ret;
     ...
     */
    template<class T>
    class BetaDistribution : public Distribution<T> {
    public:
     ...
     */
    template<class T>
    T dbinom(const T &x, const T &n, const T &p) {
     ...
     */
    template<class T>
    T pbinom(const T &x, const T &n, const T &p) {
        if (n <= x) {
            return T(1);
        }
     ...
     */
    template<class T>
    size_t qbinom(const T &probability, const T &n, const T &p) {
        ...
        do {//need to work this out beter.
            ...
            error = pnorm<double > (x, np, std) - probability;
     ...
     */
    template<class T>
    T rbinom(const T &n, const T &p) {
        double x = ((double) rand() / (double) RAND_MAX);

        T ret = qbinom<double> (x, n, p);
        return ret;
    }
     ...
     */
    template<class T>
    T pcauchy(const T &x, const T &location, const T &scale) {
     ...
     */
    template<class T>
    T dcauchy(const T &x, const T &location, const T &scale) {
     ...
     */
    template<class T>
    T qcauchy(const T &probability, const T &location, const T &scale) {
     ...
     */
    template<class T>
    T rcauchy(const T &location, const T &scale) {
        double x = ((double) rand() / (double) RAND_MAX);
        T ret = T(qcauchy<double> (x, location, scale));
        return ret;
    }
     ...
     */
    template<class T>
    class CauchyDistribution : public Distribution<T> {
    public:
     ...
     */
    template<class T>
    T dpois(const T &x, const T &lambda) {
        return (atl::mfexp<T > (x * std::log(lambda) - lambda - atl::GammaLn(x + T(1))));
    }
     ...
     */
    template<class T>
    int qpois(const T &probability, const T &lambda) {
        T result = T(0);
        T guess = 4;
        T high = T(100 * lambda);
        T low = T(0);
        ...
        while (std::fabs(dx) > T(1e-10) && i++ < MAX_ITERATIONS) {//need to work this out beter.
            ...
            error = ppois<double > (x, lambda) - probability;
     ...
     */
    template<class T>
    T rpois(const T &lambda) {
        double x = ((double) rand() / (double) RAND_MAX);
        T ret = qpois<double> (x, lambda);
        return ret;
    }
     ...
     */
    template<class T>
    class PoissonDistribution : public Distribution<T> {
    public:
     ...
     */
    template<class T>
    T pgamma(const T &x, const T &shape, const T &scale) {
     ...
     */
    template<class T>
    T dgamma(const T &x, const T &shape, const T &scale) {
     ...
     */
    template<class T>
    T qgamma(const T &probability, const T &shape, const T &scale) {
     ...
     */
    template<class T>
    T rgamma(const T &shape, const T &scale) {
        double x = ((double) rand() / (double) RAND_MAX);
        T ret = qgamma<double> (x, shape, scale);
        return ret;
    }
     ...
     */
    template<class T>
    class GammaDistribution : public Distribution<T> {
    public:
     ...
     */
    template<class T>
    T qchisq(const T &probability, const T &df) {
     ...
     */
    template<class T>
    class ChiSquaredDistribution : public Distribution<T> {
    public:
     ...
     */
    template<class T>
    T qexp(const T &probability, const T &rate) {
        T result = T(0);
        T guess = 4;
        T high = T(100);
        T low = T(0);
     ...
     */
    template<class T>
    T pf(const T &x, const T &d1, const T &d2) {
     ...
     */
    template<class T>
    T df(const T &x, const T &d1, const T &d2) {
     ...
     */
    template<class T>
    T qf(const T &probability, const T &d1, const T &d2) {
     ...
     */
    template<class T>
    T rf(const T &d1, const T &d2) {
        double x = ((double) rand() / (double) RAND_MAX);
        T ret = qf<double>(x, d1, d2);
        return ret;
    }
     ...
     */
    template<class T>
    class FDistribution : public Distribution<T> {
    public:
     ...
     */
    template<class T>
    T qgeom(const T &probability, const T &p) {
     ...
     */
    template<class T>
    class GeometricDistribution : public Distribution<T> {
    public:
     ...
     */
    template<class T>
    T dhyper(const T &x, const T &m, const T &n, const T &k) {
     ...
     */
    template<class T>
    T phyper(const size_t &x, const T &m, const T &n, const T &k) {
     ...
     */
    template<class T>
    T qhyper(const T &probability, const T &m, const T &n, const T &k) {
        T result = T(0);
        T guess = 4;
        T high = T(100);
        T low = T(0);
     ...
     */
    template<class T>
    T rhyper(const T &m, const T &n, const T &k) {
        double x = ((double) rand() / (double) RAND_MAX);
     ...
     */
    template<class T>
    class HypergeometricDistribution : public Distribution<T> {
    public:
     ...
     */
    template<class T>
    T plogis(const T &x, const T &location, const T &scale) {
     ...
     */
    template<class T>
    T dlogis(const T &x, const T &location, const T &scale) {
     ...
     */
    template<class T>
    T qlogis(const T &probability, const T &location, const T &scale) {
     ...
     */
    template<class T>
    T rlogis(const T &location, const T &scale) {
        double x = ((double) rand() / (double) RAND_MAX);
        T ret = qlogis<double>(x, location, scale);
        return ret;
    }
     ...
     */
    template<class T>
    class LogisticDistribution : public Distribution<T> {
    public:
     ...
     */
    template<class T>
    T plnorm(const T &x, const T &meanLog, const T &sdLog) {
        if (x >= T(0)) {
     ...
     */
    template<class T>
    T dlnorm(const T &x, const T &meanLog, const T &sdLog) {
        if (x > T(0)) {
     ...
     */
    template<class T>
    T qlnorm(const T &probability, const T &meanLog, const T &sdLog) {
     ...
     */
    template<class T>
    T rlnorm(const T &meanLog, const T &sdLog) {
        double x = ((double) rand() / (double) RAND_MAX);
     ...
     */
    template<class T>
    class LogNormalDistribution : public Distribution<T> {
    };
     ...
     */
    template<class T>
    T dnbinom(const T &x, const size_t &n, const T &p) {
     ...
     */
    template<class T>
    T pnbinom(const T &x, const size_t &n, const T &p) {
     ...
     */
    template<class T>
    T qnbinom(const T &probability, const size_t &n, const T &p) {
     ...
     */
    template<class T>
    T rnbinom(const T &n, const T &p) {
        double x = ((double) rand() / (double) RAND_MAX);
        T ret = qnbinom<double>(x, n, p);
        return ret;
    }

    template<class T>
    class NegativeBinomialDistribution : public Distribution<T> {
    };
     ...
     */
    template<class T>
    T qt(const T &probability, const T &df) {
    ...
    T rt(const T &df) {
        double x = ((double) rand() / (double) RAND_MAX);
        T ret = qt<double>(x, df);
        return ret;
    }

    template<class T>
    class StudentTDistribution : public Distribution<T> {
    };
     ...
     */
    template<class T>
    T punif(const T &x, const T &min, const T &max) {
        if (x < min) {
            return T(0);
        } else if (x >= max) {
            return T(1);
     ...
     */
    template<class T>
    T dunif(const T &x, const T &min, const T &max) {
        if (min <= x && x <= max) {
     ...
     */
    template<class T>
    T qunif(const T &probability, const T &min, const T &max) {
     ...
     */
    template<class T>
    T runif(const T &min, const T &max) {
        double x = ((double) rand() / (double) RAND_MAX);
        T ret = qunif<double> (x, min, max);
        return ret;
    }
     ...
     */
    template<class T>
    T pweibull(const T &x, const T &shape, const T &scale) {
     ...
     */
    template<class T>
    T dweibull(const T &x, const T &shape, const T &scale) {
     ...
     */
    template<class T>
    T qweibull(const T &probability, const T &shape, const T &scale) {
        T result = T(0);
        T guess = 4;
        T high = T(100);
        T low = T(0);
     ...
     */
    template<class T>
    T rweibull(const T &shape, const T &scale) {
        double x = ((double) rand() / (double) RAND_MAX);
        T ret = qweibull<double> (x, shape, scale);
        return ret;
    }

    template<class T>
    class WiebullDistribution : public Distribution<T> {
    };
